...
public class ContactPointBuilder {
    ...
    public ContactPointBuilder email(final String email) {
        if (email != null) {
            resource.addProperty(VCARD4.hasEmail, no.norge.data.skos_ap_no.concept.builder.Conceptcollection.ContactPointBuilder.emailResource(parent.getModel(), email));
        }
        return this;
    }
    ...
    public ContactPointBuilder telephone(final String telephone) {
        if (telephone != null) {
            resource.addProperty(VCARD4.hasTelephone, no.norge.data.skos_ap_no.concept.builder.Conceptcollection.ContactPointBuilder.telephoneResource(parent.getModel(), telephone));
        }
        return this;
    }
